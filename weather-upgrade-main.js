$(document).ready(function () {
            ...
            fetch(geocoderUrl)
              ...
              .then((data) => {
                ...
                if (features.length > 0) {
                  var locationName = features[0].place_name;
                  cityContext = features[0].context.find(context => context.id.includes('place'));
                  stateContext = features[0].context.find(context => context.id.includes('region'));
                  countryContext = features[0].context.find(context => context.id.includes('country'));
                // Extract city, state, and country names
    ...
    const endDay = new Date(yearForTargetMonth, targetMonth , 1 + 1);
    ...
    const formatDate = (date) => {
      ...
      var averageCon01 = $("#averageCon01").val();
      var averageCon02 = $("#averageCon02").val();
      var aboveAvgCon01 = $("#aboveAvgCon01").val();
      var aboveAvgCon02 = $("#aboveAvgCon02").val();
      var muchAboveAvgCon1 = $("#muchAboveAvgCon1").val();
      var muchAboveAvgCon2 = $("#muchAboveAvgCon2").val();
      var extremeAboveAvgCon = $("#extremeAboveAvgCon").val();
      var belowAvgCon1 = $("#belowAvgCon1").val();
      var belowAvgCon2 = $("#belowAvgCon2").val();
      var muchBelowAvgCon1 = $("#muchBelowAvgCon1").val();
      var muchBelowAvgCon2 = $("#muchBelowAvgCon2").val();
      var extremeBelowAvgCon = $("#extremeBelowAvgCon").val();
                            ...
                            monthsData[key] &&
                              monthsData[key].forEach((item) => {
                                if (item.day === dateCounter) {
                                  ...
                                  const snowOpacity =
                                    isSnow && parseFloat(snowValue) < snowAvgValue ? 0 : 1;
