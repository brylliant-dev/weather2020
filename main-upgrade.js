                            ...
                            monthsData[key] &&
                                  ...
                                  const determineBackgroundColor = (normalTmax) => {
                                    ...
                                    if (units === "metric") {
                                      ...
                                      if (isSnow) {
                                        ...
                                        return prcpResult > prcpValueNormals && prcpResult >= 1.27
                                        ? "prcp-background"
                                        : "transparent";
                                      }
                                    } else {
                                      ...
                                      if (isSnow) {
                                        ...
                                        return prcpResult > prcpValueNormals && prcpResult >= 0.05
                                          ? "prcp-background"
                                          : "transparent";
                                      }
                                    }
                              ...
                              // )["prcp"])
                                  ...
                                  cell.append(`<div class="${dataType} ${backgroundColor}"> ${
                                    ((dataType !== "prcp" || (prcpValue !== 0 && prcpValue !== '0.00' && prcpValue !== '')) && imageSrc) 
